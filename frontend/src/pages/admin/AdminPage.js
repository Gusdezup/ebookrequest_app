                          ...
                          <td className={styles.adminExpandCell} colSpan={7}>
                            <div className={styles.adminExpandPanel}>
                              ...
                              <div className={styles.statusButtons}>
                                ...
                                <button className={styles.aIconBtn} title="Conversation" style={{ position: 'relative' }}
                                  onClick={() => setThreadModal(request)}>
                                  {request.comments?.some(c => c.role === 'user' && !c.seenByAdmin) && (
